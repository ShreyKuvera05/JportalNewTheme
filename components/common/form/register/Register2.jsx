  ...
  return (
    <div className="form-inner">
      ...
      <Tabs>
        ...
        <form method="post" action="add-parcel.html" onSubmit={handleOk}>
            ...
            <div className="col-lg-6 col-md-6 col-12">
              ...
              {formData.customerID && customerIdMsg && (
                ...
                >
                  ...
                  <span
                    className={
                      customerIdMsg === "Available" ? "d-block ps-3" : "d-none"
                    }
                  >
                    <FaCheck />
                  </span>
      ...
      <div className="bottom-box">
        <div className="text">
          ...
          <Link href="/authentication/signin" className="call-modal login">
            LogIn
          </Link>
        </div>
